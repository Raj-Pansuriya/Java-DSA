public class Scope {
    public static void main(String[] args) {
        ...
        // block Scope
        {
            ...
            // again
            int c = 30;
            // below line will update the original var. `a` as its using the same reference
            // variable.
            // We haven't initialized any other `a` hence the block is bound to use the same
            // reference variable.
            a = 5;
        ...
        int c = 100;
        // As pur code do not know any `c` outside the abouve block, hence we can
        // initialize it again.
